...
import { useMediaQuery  , IconButton , Typography , Toolbar , Box , AppBar} from "@mui/material";
      ...
      <AppBar position="static" sx={{ height:iconSize ? 60 : 80}} >
        <Toolbar variant="dense" sx={{ height:'100%'}}>
          ...
          <IconButton edge="end" color="inherit" aria-label="menu" sx={{ gap: 1 }}>
            ...
            <img src={LogistikaUgdaAvish} alt="LogoLogistikaUgdaAvish" style={{ width: isSmallScreen ? 35 :60, height: iconSize }} />
          </IconButton>
        </Toolbar>
      </AppBar>
    </Box>
